          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M9.5 2A1.5 1.5 0 008 3.5V5H4a2 2 0 00-2 2v10a2 2 0 002 2h16a2 2 0 002-2V7a2 2 0 00-2-2h-4V3.5A1.5 1.5 0 0014.5 2h-5zM9.5 5V3.5h5V5h-5zm2.5 5a3.75 3.75 0 100 7.5 3.75 3.75 0 000-7.5z"
              />
              <path d="M10.1 18.6h3.8a.9.9 0 01.9.9 1.5 1.5 0 01-1.5 1.5h-2.6a1.5 1.5 0 01-1.5-1.5.9.9 0 01.9-.9z" />
            </svg>
          </button>
        </Tooltip>
